...
# by setting a global variable in a production server.
$home = {}

# This is a ruby class that includes validations fro ActiveRecord.
# This will represent our Home resource as a ruby object
class Home
  # Active Model is part of ruby on rails
  # It is used as an ORM 
  # It has a module within ActiveModule that provides validations
