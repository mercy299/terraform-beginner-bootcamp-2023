...
[Terraform Provisioners](https://developer.hashicorp.com/terraform/language/resource/provisioners/syntax)

### Local-exec
This will execute a comand on the machine running the terraform commands eg. plan, apply 
